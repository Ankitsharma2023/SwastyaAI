		...
		>
			<SidebarGroup>
				<div class="flex w-full flex-row items-center justify-start">
					<SidebarItem
						class="-mb-2 ml-0 h-8 w-40 font-medium text-white"
						label="Home"
						{spanClass}
						on:click={() => {
							toggleSidebar();
...
>
    ...
    />
				...
				<SidebarItem
					class="mt-4 ml-0 h-8 w-40 font-medium text-white"
					label="Chatbot"
					{spanClass}
					on:click={() => {
						toggleSidebar();
...
>
    ...
    />
				...
				<SidebarItem
					class="ml-0 h-8 w-40 font-medium text-white"
					label="Recording"
					{spanClass}
					on:click={() => {
						toggleSidebar();
...
>
    ...
    <path
        ...
        stroke-linejoin="round"
    />
    <path d="M7.62575 15.3345L4.63281 17.7573" stroke="#FFFFFF" stroke-linejoin="round" />
</svg>
...
<div class="dark:bg-dark flex items-center justify-between p-4 text-black dark:text-white" style="background-color: #65A765;">
